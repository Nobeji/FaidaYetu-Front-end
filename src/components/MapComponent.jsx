...
const satelliteStyle = {
  version: 8,
  sources: {
    tomtom_sat: { type: 'raster', tiles: [`https://api.tomtom.com/map/1/tile/hybrid/main/{z}/{x}/{y}.png?tileSize=256&key=${key}`], tileSize: 256, attribution: '&copy; TomTom' },
  },
  layers: [
    { id: 'tomtom-sat', type: 'raster', source: 'tomtom_sat' },
  ],
};
