  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: bgGradient, color: '#e8fff0' }}>
      <style>{`
        ...
        .admin-section-label { letter-spacing: 0.1em; }
      `}</style>
      ...
      <aside style={{
        ...
        {/* Brand */}
        <div style={{ minWidth: 260, padding: '24px 20px 20px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 700, color: '#fff', letterSpacing: '-0.02em', whiteSpace: 'nowrap' }}>FaidaYetu</div>
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.4)', whiteSpace: 'nowrap' }}>Admin Console</div>
            </div>
          </div>
        </div>
        ...
        <nav style={{ flex: 1, minWidth: 260, padding: '12px 8px', overflowY: 'auto' }}>
          {sidebarSections.map((section) => (
            <div key={section.label} style={{ marginBottom: 4 }}>
              <div className="admin-section-label" style={{
              ...
              {section.items.map((item) => {
                ...
                return (
                  <div key={item.label} className="admin-nav-item" onClick={() => { navigate(item.nav); if (isMobile) setSidebarOpen(false); }} style={{
                    ...
                    whiteSpace: 'nowrap',
                    border: active ? '1px solid rgba(10,110,70,0.25)' : '1px solid transparent',
                  }}>
        ...
        {/* User + Logout */}
        <div style={{ minWidth: 260, padding: '16px', borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 'auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px', marginBottom: 6 }}>
            <div style={{
              ...
              boxShadow: '0 2px 8px rgba(10,110,70,0.3)',
            }}>{initials}</div>
            <div>
          ...
          <div onClick={() => {
            ...
            color: 'rgba(255,138,128,0.8)', fontWeight: 500, fontSize: 13, whiteSpace: 'nowrap',
            transition: 'all 0.2s',
          }}>
