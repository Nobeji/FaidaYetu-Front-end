    ...
    <DashboardShell brand="FaidaYetu" brandSub="Poultry Logistics Hub" navItems={navItems} profile={
      ...
      <div>
        <div style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', margin: 0 }}>Supplier Dashboard</h1>
          <p style={{ fontSize: 13, color: '#64748b', margin: '4px 0 0' }}>Manage your poultry operations.</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', background: '#fef9c3', border: '1px solid #fde68a', borderRadius: 10, marginBottom: 24, flexWrap: 'wrap' }}>
              ...
              <button onClick={() => navigate('/supplier/orders')} style={{ padding: '8px 16px', borderRadius: 8, background: '#0a6e46', border: 'none', cursor: 'pointer', fontWeight: 600, fontSize: 12, color: '#fff' }}>Review Alerts</button>
            </div>
              ...
              {editLocation ? (
                <>
                  ...
                  <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                    <button onClick={() => { setEditLocation(false); setLocationCoords(originalCoords); }} style={{ flex: 1, padding: '8px', borderRadius: 8, border: '1px solid #e2e8f0', background: '#fff', cursor: 'pointer', fontWeight: 500, fontSize: 12, color: '#475569' }}>Cancel</button>
            ...
            <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: 16, marginBottom: 20 }}>
              ...
              {data.orders.filter(o => o.delivery_lat && o.delivery_lng).length === 0 && (
                <div style={{ textAlign: 'center', padding: 20, color: '#94a3b8', fontSize: 13 }}>No delivery locations yet.</div>
              )}
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '2fr 1fr', gap: 20 }}>
              <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, overflow: 'hidden' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px', borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <span onClick={() => navigate('/supplier/orders')} style={{ fontSize: 12, color: '#0a6e46', cursor: 'pointer', fontWeight: 600 }}>View All</span>
                </div>
              ...
              <div>
                <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: '20px', marginBottom: 20 }}>
                  <h3 style={{ fontSize: 15, fontWeight: 600, color: '#0f172a', margin: '0 0 16px' }}>Inventory Status</h3>
